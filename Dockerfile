...
https://github.com/jneilliii/OctoPrint-PrusaSlicerThumbnails/archive/refs/heads/master.zip \
https://github.com/OllisGit/OctoPrint-SpoolManager/archive/refs/heads/master.zip \
...
RUN chmod 555 /etc/sudoers.d/klippy
...
COPY docker-chmod.conf /etc/init/docker-chmod.conf
COPY start.py /
COPY runklipper.py /
